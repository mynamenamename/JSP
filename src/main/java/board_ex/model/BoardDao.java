	...
	*/
	public int insert( BoardVO rec ) throws BoardException
	{
		...
		try{
			...
			//* sql 문장 만들기
			String putQuery		= " INSERT INTO board_ex (seq, title,writer,content, regdate, cnt, pass) VALUES (seq_board.nextval,?,?,?,sysdate,?,?) ";  
